    ...
    <>
      <nav
        ...
        className="hidden md:flex fixed top-4 left-1/2 -translate-x-1/2 backdrop-blur-md
          ...
          dark:bg-[#262B40] dark:border-gray-500 dark:text-gray-200"
      >
        {/* بخش راست */}
        <div className="flex items-center gap-6">
          {/* لوگو و آیکون Home */}
          ...
          >
            ...
            >
              <Home 
                size={30} 
                className="text-gray-800 dark:text-gray-200 hover:text-sky-300 dark:hover:text-white -my-5" 
                strokeWidth={1.5}
              />
            </div>
          </div>
          ...
          <div
            ...
            className="flex items-center gap-2 px-6 cursor-pointer hover:text-sky-300 dark:hover:text-white transition"
          >
          ...
          <div
            ...
            className="relative flex items-center gap-2 px-6 cursor-pointer hover:text-sky-300  dark:hover:text-white transition"
          >
